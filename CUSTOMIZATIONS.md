...
### 🖥️ Màn hình nền trong suốt & Nút bật/tắt nhanh (Transparent Desktop & Quick Toggle)
* **Tệp tin ảnh hưởng:**
  ...
  * [Toggles.qml](file:///home/qkhanh/Code/Kde%20caelestia/caelestia-dots-kde/shell/modules/utilities/cards/Toggles.qml)
  * [UtilitiesPage.qml](file:///home/qkhanh/Code/Kde%20caelestia/caelestia-dots-kde/shell/modules/nexus/pages/UtilitiesPage.qml)
* **Chi tiết:** Thêm lại công tắc bật/tắt **"Transparent desktop window"** trong trang *Nexus > Wallpaper & Style > Desktop Addons* và bổ sung nút gạt nhanh **Quick Toggle** tương ứng vào thẻ Control Center:
  * **Trạng thái Bật (ON - Mặc định Caelestia gốc):** Bật đầy đủ cửa sổ nền Caelestia gốc với hình nền, Lời bài hát (DesktopLyrics), Sóng nhạc (Visualiser) và Đồng hồ Desktop. Trang *Nexus > Appearance* hiển thị xem trước hình nền và cho phép chọn ảnh như bản gốc $100\%$.
  * **Trạng thái Tắt (OFF):** Tắt hoàn toàn cửa sổ nền Caelestia và tất cả các tính năng liên quan (Hình nền Caelestia, Visualiser, Lời bài hát, Đồng hồ Desktop...), đưa CPU/RAM tiêu thụ cho phần nền về $0\%$ tuyệt đối giúp màn hình hoàn toàn sạch vẽ.
